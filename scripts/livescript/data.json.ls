DATA = 
	...
	education: [
		...
		date		: from: 'October 2009' to: 'July 2013'
	,
		title		: 'PGTE "Henry Ford"'
		type		: 'High School'
		major		: 'Automobiles'
		date		: from: 'September 2001' to: 'July 2006'
	]
	
	events: [
		title		: 'Google IO 2011 Developer Conference '
		date		: from: '10th May 2011' to: '11th May 2011'
	...
	experience: [
		...
		positions	: [
			...
			tasks		:
				...
				'Incorporate the usage PHP MVC based framework with ORM, Active Record, Smarty template engine and multilingual support'
				'Engineer and develop PHP/MySQL(MariaDB) web based sites and systems using MVC framework'
		...
		,
			...
			tasks		: 
				...
				'Administration (PHP/MySQL using MVC framework)'
		,
			title		: 'Histroypin - American Experience '
			url			: \http://historypin.americanexperience.org/
			desc		: 'TO BE DESCRIBED'
			tasks		: 
				'System Architecture'
				'Database Design'
	...
	,
		...
		positions	: [
			...
			date		: from: 'October 2010' to: 'December 2011'
			tasks		:
				'Manage web department & projects'
				'Lead, guide and train a team of developers'
				'Incorporate the usage PHP MVC based framework with ORM, Active Record, Smarty template engine and multilingual support'
		...
		,
			...
			date		: from: 'March 2008' to: 'October 2010'
			tasks		:
				'Lead, guide and train a team of developers'
				'Incorporate the usage PHP MVC based framework with ORM, Active Record, Smarty template engine and multilingual support'
				'Engineer and develop PHP/MySQL(MariaDB) web based sites and systems using MVC framework'
	...
	,
		...
		positions	: [
			title		: \Developer
			date		: from: 'April 2007' to: 'March 2008'
			tasks		:
	...
	,
		...
		positions	: [
			...
			date		: from: 'July 2006' to: 'April 2007'
			tasks		:
